    ...
    <div className="min-h-screen bg-gradient-to-br from-cyber-dark via-gray-900 to-cyber-dark flex items-center justify-center p-4">
      <div className="max-w-3xl w-full text-center">
        <div className="mb-8 animate-fade-in">
          ...
          <p className="text-cyber-green text-2xl font-semibold">Think Before You Click</p>
        </div>

        <div className="bg-gray-800/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50 animate-scale-in mb-8">
          ...
          <div className="grid grid-cols-3 gap-4 text-center mb-8">
            ...
            <div>
              ...
              <div className="text-gray-300 font-medium text-lg">~10 Minutes</div>
            </div>
            <div>
              <div className="text-5xl mb-2">🧠</div>
              <div className="text-gray-300 font-medium text-lg">Judgment, not luck</div>
            </div>
          </div>

          <button
            onClick={onStart}
            className="px-14 py-6 bg-gradient-to-r from-cyber-blue to-cyan-500 text-white text-3xl font-bold rounded-2xl hover:from-cyan-500 hover:to-cyber-blue transition-all transform hover:scale-[1.04] focus:outline-none focus:ring-4 focus:ring-cyber-blue/40"
          >
            🚀 Begin the Show
          </button>
        </div>

        <div className="text-gray-500 text-lg animate-fade-in">

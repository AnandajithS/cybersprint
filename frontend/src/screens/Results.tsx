    ...
    <div className="min-h-screen bg-gradient-to-br from-cyber-dark via-gray-900 to-cyber-dark py-8 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="animate-scale-in mb-8">
          ...
          <div className="text-sm uppercase tracking-widest text-cyber-blue font-semibold mb-2">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50 mb-8 animate-slide-up">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-gray-900/60 rounded-2xl p-6">
              ...
              <div className="text-gray-400 text-lg mt-2">Security</div>
            </div>
            <div className="bg-gray-900/60 rounded-2xl p-6">
              ...
              <div className="text-gray-400 text-lg mt-2">Money Saved</div>
            </div>
            <div className="bg-gray-900/60 rounded-2xl p-6">
              <div className="text-4xl mb-2">🚩</div>
              ...
              <div className="text-gray-400 text-lg mt-2">Threats Stopped</div>
            </div>
            <div className="bg-gray-900/60 rounded-2xl p-6">
              <div className="text-4xl mb-2">👍</div>
              ...
              <div className="text-gray-400 text-lg mt-2">Good Decisions</div>
            </div>
          </div>
        </div>

        <div className="bg-gray-800/40 backdrop-blur-sm rounded-3xl p-6 border border-gray-700/50 mb-8 animate-slide-up">
          <h3 className="text-2xl font-bold text-white mb-4">🗺️ Your Journey</h3>
          {decisions.length === 0 ? (
            <p className="text-gray-400 text-lg">No decisions recorded yet.</p>
          ) : (
            <div className="grid md:grid-cols-2 gap-3 text-left max-h-80 overflow-y-auto scrollbar-hide">
              {decisions.map((d, i) => (
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">{d.consequence}</p>
                </div>
              ))}
            </div>
          )}

  ...
  return (
    <div className="animate-scale-in">
      <div className="bg-gray-800/40 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-8 sm:p-12 text-center mb-8">
        ...
        <div className="text-lg uppercase tracking-widest text-cyber-yellow font-semibold mb-3">
        ...
        <div className="bg-cyber-blue/10 rounded-2xl border border-cyber-blue/20 p-8 max-w-3xl mx-auto text-center">
          <div className="text-cyber-blue font-bold text-2xl mb-3">Lesson</div>
          <p className="text-2xl sm:text-3xl text-gray-200 leading-relaxed">{story.resolution}</p>
        </div>
      </div>

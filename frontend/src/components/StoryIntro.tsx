...
export default function StoryIntro({
  ...
  return (
    <div className="min-h-full flex flex-col items-center justify-center text-center px-6 py-10 animate-scale-in">
      <div className="text-sm uppercase tracking-widest text-cyber-blue font-semibold mb-4">
      ...
      <div className="bg-gray-800/60 backdrop-blur rounded-2xl border border-gray-700/50 p-6 sm:p-8 mb-10 max-w-3xl">
        <p className="text-xl sm:text-2xl text-gray-200 leading-relaxed">{story.intro}</p>
      </div>
      ...
      >
        🎤 Call a student & Start
      </button>

      <p className="text-gray-500 text-lg mt-6">
        A student chooses what the 'you' in the story should do. Click on the screen!
      </p>
    </div>
  );
}